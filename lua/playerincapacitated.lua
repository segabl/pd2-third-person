-- check if we need to switch to first person on incap
Hooks:PreHook(PlayerIncapacitated, "enter", "enter_third_person", function (self)
...
Hooks:PreHook(PlayerIncapacitated, "exit", "exit_third_person", function (self)
